...
router.post(route[3], [middleware.CreateScheduleToVisit], controller.VisitController.createScheduleVisit)
router.post(route[4], [middleware.CreatePeopleToVisit], controller.VisitController.createPeopleToVisit)
...
router.get(route[10], controller.VisitController.getVisitType)
router.get(route[11], controller.VisitController.getOutputVisitType)
