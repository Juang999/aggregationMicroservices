...
router.get(Client.feature.product.product_catalog, Controller.Client.ProductController.getCatalog)
...
router.get(Client.feature.product.product_catalog_mutifers, Controller.Client.ProductController.getCatalogForMutifersApp)
